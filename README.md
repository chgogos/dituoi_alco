...
[Θέματα προετοιμασίας για την πρόοδο](./resources/20211202-midterm-prepare.pdf)
...
Διάφορα προβλήματα στα οποία εφαρμόζεται η τεχνική του ``δυναμικού προγραμματισμού'': πρόβλημα 0-1 σακιδίου (0-1 knapsack), αλγόριθμος των Floyd-Warshall εύρεσης συντομότερων διαδρομών για όλα τα ζεύγη κορυφών σε γράφο, μέγιστη κοινή υποακολουθία (longest common subsequence).
